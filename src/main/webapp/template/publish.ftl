    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/publishSubmit" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <input class="u-ipt ipt" name="cTitle" autofocus placeholder="2-80字符"/>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">摘要：</label>
                <div class="fmipt">
                    <input class="u-ipt ipt" name="cAbstract" placeholder="2-140字符"/>
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="cImgUrl" placeholder="图片地址"/>
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <textarea class="u-ipt" name="cText" rows="10" placeholder="2-1000个字符"></textarea>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">价格：</label>
                <div class="fmipt">
                    <input class="u-ipt price" name="cPrice"/>元
                </div>
            </div>
