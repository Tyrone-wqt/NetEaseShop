...
<#include "/include/header.ftl"><div class="g-doc">
    ...
    <div class="n-public">
        <form class="m-form m-form-ht" id="form" method="post" action="/editSubmit?id=${content.id}" onsubmit="return false;" autocomplete="off">
            <div class="fmitem">
                ...
                <div class="fmipt">
                    ...
                    <input class="u-ipt ipt" name="cTitle" value="${content.cTitle}" placeholder="2-80字符"/>
                </div>
            </div>
            <div class="fmitem">
            ...
            <div class="fmitem">
                ...
                <div class="fmipt" id="urlUpload">
                    <input class="u-ipt ipt"  name="cImgUrl" value="${content.cImgUrl}" placeholder="图片地址"/>
                </div>
            ...
            <div class="fmitem">
                ...
                <div class="fmipt">
                    <textarea class="u-ipt" name="cText" rows="10" placeholder="2-1000个字符">${content.cText}</textarea>
                </div>
            </div>
            <div class="fmitem">
                <label class="fmlab">价格：</label>
                <div class="fmipt">
                    <input class="u-ipt price" name="cPrice" value="${content.cPrice}"/>元
                </div>
            </div>
        ...
        <span class="imgpre"><img src="${content.cImgUrl}" alt="" id="imgpre"></span>
    </div>
    </#if>
</div>
